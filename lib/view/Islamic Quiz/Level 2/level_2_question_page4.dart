...
class L2QuestionPage4 extends StatefulWidget {
  const L2QuestionPage4({super.key});

  @override
  State<L2QuestionPage4> createState() => _L2QuestionPage4State();
}

class _L2QuestionPage4State extends State<L2QuestionPage4> {
      ...
      setState(() {
        if(counter_seconds>0){
          ...
          Navigator.pushReplacement(context,
              MaterialPageRoute(builder: (context)=>const L2QuestionPage5()));
        }
      });
    });
  }
